-- Convierte el checkout en una operacion transaccional para evitar
-- ordenes parciales y compras duplicadas por condiciones de carrera.
...
revoke all on function public.create_checkout_order(uuid) from anon;
